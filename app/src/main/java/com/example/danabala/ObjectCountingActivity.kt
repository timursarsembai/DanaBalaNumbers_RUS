...
class ObjectCountingActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun generateQuestion() {
        ...
        // Обновляем текст вопроса с названием предмета
        val itemName = emojiNames[selectedEmoji] ?: "предметов"
        val questionText = "Сколько ты видишь $itemName?"
